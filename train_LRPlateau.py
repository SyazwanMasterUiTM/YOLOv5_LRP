...
def train(hyp, opt, device, tb_writer=None, wandb=None):
   ...
   # else:
    ...
    scheduler1 = lr_scheduler.LambdaLR(optimizer, lr_lambda=lf)
    lr_metric = 0
    scheduler2 = lr_scheduler.ReduceLROnPlateau( optimizer, patience=10, mode = 'min', verbose=True)
    ...
    scheduler1.last_epoch = start_epoch - 1  # do not move
